...
export function Home(){
    ...
    return(
        <div className="">
            ...
            <p className=" bounce-in-left text-light-gray text-center font-reg lg:text-lg text-base pt-2 lg:text-left xs:w-100 lg:mx-0 lg:w-100 pb-20 xs:leading-7 lg:leading-8 leading-6">Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!</p>
            </div>
